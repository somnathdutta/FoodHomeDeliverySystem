...
public class PromoCodeMasterSql {
	...
	public static final String loadPromoCodeDetailsSql = "select fapp_promo_code_details_id, promo_code_id, promo_code, from_date, to_date, promo_type_id, promo_code_type,"
														  + "promo_code_application_type_id , promo_code_application_type, promo_code_is_active, promo_value,volume_quantity,is_reusable from vw_promo_code_details ";
	...
	public static final String upDatePromoCodeDetailsSql = "update fapp_promo_code_details set is_reusable = ?, from_date = ?, to_date = ?, promo_type_id = ?, promo_code_application_type_id= ?, "
