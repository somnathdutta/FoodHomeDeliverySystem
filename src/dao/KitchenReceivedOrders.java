...
public class KitchenReceivedOrders {

	public static ArrayList<ReceivedOrderBean> loadKitchenReceivedOrders(Connection connection, String kitchenName){
		ArrayList<ReceivedOrderBean> receivedOrderBeanList = new ArrayList<ReceivedOrderBean>();
		try {
			SQL:{
					PreparedStatement preparedStatement = null;
					ResultSet resultSet = null;
					String sql = "select * from vw_kitchen_received_orders where kitchen_id= "
	...
	public static ArrayList<ReceivedOrderBean> showKitchenReceivedOrdersWithinRange(Connection connection, String kitchenName,
