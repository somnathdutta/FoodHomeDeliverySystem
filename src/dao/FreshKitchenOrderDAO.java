...
public class FreshKitchenOrderDAO {

	public static ArrayList<ReceivedOrderBean> loadKitchenFreshOrders(Connection connection, String kitchenName){
		ArrayList<ReceivedOrderBean> receivedOrderBeanList = new ArrayList<ReceivedOrderBean>();
		try {
			SQL:{
					PreparedStatement preparedStatement = null;
					ResultSet resultSet = null;
					String sql = "select * from vw_kitchen_fresh_orders where kitchen_id= "
	...
	public static ArrayList<ReceivedOrderBean> showKitchenFreshOrdersWithinRange(Connection connection, String kitchenName,
